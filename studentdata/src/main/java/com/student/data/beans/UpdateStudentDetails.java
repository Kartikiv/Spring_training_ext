...
public class UpdateStudentDetails {
	...
	public UpdateStudentDetails(Integer studentId, String firstNm, String middleNm, String lastNm, String address,
			String moblieNo, String cityNm, String townNm, String districtNm, String villageNm, Date birthDate,
			Long orgId) {
		super();
