...
import com.student.data.beans.StudentDepartment;
...
public class StudentServiceImplementation implements StudentService {
	...
	public List<FetchStudentDetailsWithMarksAndDepartmentWithNoReplications> studentDetailsWithMarks() {
		...
		List<FetchStudentDetailsWithMarksAndDepartment> fetchStudentDetailsWithMarksList = studentDao
				.studentDetailsWithMarks();
		for (FetchStudentDetailsWithMarksAndDepartment fetchStudentDetailsWithMarksAndDepartment : fetchStudentDetailsWithMarksList) {
			/*
	...
	@Override
	public Boolean insertStudentDetailsWithKeyHolder(
	...
	public List<FetchStudentDetailsWithMarksAndDepartmentNamesWithNoReplications> studentDetailsWithMarksAndDepartment() {
		List<FetchStudentDetailsWithMarksAndDepartmentNamesWithNoReplications> listStudentDetailsWithMarksAndDepartment = new ArrayList<>();
		Set<Long> set = new HashSet<>();
		Set<Long> setMarks= new HashSet<>();
		Set<Long> setDepartment=new HashSet<>();
		...
		for (FetchStudentDetailsWithMarksAndDepartmentNames fetchStudentDetailsWithMarksAndDepartmentNames : fetchStudentDetailsWithMarksAndDepartmentList) {
			/*
			 * Set check for Duplicate Id and appends all the data in the Object List
			 */
			if (set.add(fetchStudentDetailsWithMarksAndDepartmentNames.getStudentId())) {
				if (fetchStudentDetailsWithMarksAndDepartmentNamesWithNoReplications != null) {
					setMarks.clear();
					setDepartment.clear();
					fetchStudentDetailsWithMarksAndDepartmentNamesWithNoReplications.setMarklist(studentMarkList);
					fetchStudentDetailsWithMarksAndDepartmentNamesWithNoReplications.setDepartmentList(studentDepartmentList);
					listStudentDetailsWithMarksAndDepartment.add(fetchStudentDetailsWithMarksAndDepartmentNamesWithNoReplications);
				}
				fetchStudentDetailsWithMarksAndDepartmentNamesWithNoReplications = new FetchStudentDetailsWithMarksAndDepartmentNamesWithNoReplications();
				studentMarkList = new ArrayList<StudentMarks>();
				studentDepartmentList=new ArrayList<StudentDepartment>();
				fetchStudentDetailsWithMarksAndDepartmentNamesWithNoReplications
						.setStudentId(fetchStudentDetailsWithMarksAndDepartmentNames.getStudentId());
				fetchStudentDetailsWithMarksAndDepartmentNamesWithNoReplications
						.setAddress(fetchStudentDetailsWithMarksAndDepartmentNames.getAddress());
				fetchStudentDetailsWithMarksAndDepartmentNamesWithNoReplications
						.setCityNm(fetchStudentDetailsWithMarksAndDepartmentNames.getCityNm());
				fetchStudentDetailsWithMarksAndDepartmentNamesWithNoReplications
						.setName(fetchStudentDetailsWithMarksAndDepartmentNames.getName());

			}
			StudentDepartment studentDepartment=new StudentDepartment(fetchStudentDetailsWithMarksAndDepartmentNames.getDepartmentId(),
					fetchStudentDetailsWithMarksAndDepartmentNames.getDepartmentName());
			
			if(setDepartment.add(studentDepartment.getDepartmentId())) {
				
			studentDepartmentList.add(studentDepartment);
			}
			
			StudentMarks studentMarks = new StudentMarks(fetchStudentDetailsWithMarksAndDepartmentNames.getTotalMarks(),
					fetchStudentDetailsWithMarksAndDepartmentNames.getStage(),
					fetchStudentDetailsWithMarksAndDepartmentNames.getMarksId());
			if(setMarks.add(studentMarks.getMarksId() )|| studentMarks.getMarksId()==null) {
			if (fetchStudentDetailsWithMarksAndDepartmentNames.getTotalMarks() != null
					|| fetchStudentDetailsWithMarksAndDepartmentNames.getStage() != null
					|| fetchStudentDetailsWithMarksAndDepartmentNames.getMarksId() != null) {
		...
		return listStudentDetailsWithMarksAndDepartment;
	}
